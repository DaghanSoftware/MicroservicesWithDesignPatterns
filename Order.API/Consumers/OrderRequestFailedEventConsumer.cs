...
namespace Order.API.Consumers
{
    public class OrderRequestFailedEventConsumer : IConsumer<IOrderRequestFailedEvent>
    {
        ...
        private readonly ILogger<OrderRequestFailedEvent> _logger;

        public OrderRequestFailedEventConsumer(AppDbContext context, ILogger<OrderRequestFailedEvent> logger)
        {
            _context = context;
            _logger = logger;
        }
